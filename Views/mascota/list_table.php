...
<body class="homepage bg-light">
  ...
  <div class="p-4 shadow-sm" style="background-color: #ADB8B2; border-radius: 15px;">
    <!-- Título -->
    <h1 class="text-center mb-4" style="color:rgb(42, 42, 42); font-weight: bold;">Listado de Mascotas</h1>

    <!-- Botón Crear Mascota -->
    <div class="text-end mb-3">
      <a href="/DrVet/Views/mascota/form.php" class="btn btn-success" style="background-color: #869B8F; border-color:rgb(255, 255, 255); color: #fff;">Crear Nueva Mascota</a>
    </div>
        ...
        <?php if (!empty($mascotas)): ?>
          <?php foreach ($mascotas as $mascota): ?>
            <tr>
              ...
              <td>
                <a href="/DrVet/Views/mascota/form.php?id=<?= $mascota['ID_MASCOTA'] ?>" class="btn btn-primary btn-sm">Editar</a>
                <a href="/DrVet/Views/mascota/delete.php?id=<?= $mascota['ID_MASCOTA'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar esta mascota?');">Eliminar</a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php else: ?>
