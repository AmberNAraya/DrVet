...
<body class="homepage bg-light">
  ...
  <div class="p-4 shadow-sm" style="background-color: #ADB8B2; border-radius: 15px;">
    <!-- Título -->
    <h1 class="text-center mb-4" style="color:rgb(42, 42, 42); font-weight: bold;">Listado de Productos</h1>

    <!-- Botón Crear Producto -->
    <div class="text-end mb-3">
      <a href="/DrVet/Views/producto/form.php" class="btn btn-success" style="background-color: #869B8F; border-color:rgb(255, 255, 255); color: #fff;">Crear Nuevo Producto</a>
    </div>
        ...
        <?php if (!empty($productos)): ?>
          <?php foreach ($productos as $producto): ?>
            <tr>
              ...
              <td>
                <a href="/DrVet/Views/producto/form.php?id=<?= $producto['ID_PRODUCTO'] ?>" class="btn btn-primary btn-sm">Editar</a>
                <a href="/DrVet/Views/producto/delete.php?id=<?= $producto['ID_PRODUCTO'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?');">Eliminar</a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php else: ?>
